      ...
      <div className=" h-[70px] w-[800px] border border-zinc-200 flex items-center px-7 rounded-lg shadow-sm 2xl:w-4/5 justify-center xl:w-4/5 lg:w-4/5 md:w-4/5 sm:w-4/5">
        <nav className="flex justify-between w-full">
          <ul className="flex gap-4 container max-[800px]:justify-between">
            <li className="hover:underline hover:text-yellow-500 cursor-pointer max-[800px]:text-sm">Hambúrgueres</li>
            <li className="hover:underline hover:text-yellow-500 cursor-pointer max-[800px]:text-sm">Pizzas</li>
            <li className="hover:underline hover:text-yellow-500 cursor-pointer max-[800px]:text-sm">Complementos</li>
            <li className="hover:underline hover:text-yellow-500 cursor-pointer max-[800px]:text-sm">Sobrimesas</li>
            <li className="hover:underline hover:text-yellow-500 cursor-pointer max-[800px]:text-sm">Bebidas</li>
          </ul>
          <div className="flex">
          </div>
        </nav>
